...
export const projects: Project[] = [
  ...
  },
  {
    ...
    accentColor: '#2B2B2B',
    problem:
      'Power users on Windows lose hours every day switching between disparate tools — file search, clipboard managers, window managers, OCR, AI assistants — with no unified command surface.',
    approach:
